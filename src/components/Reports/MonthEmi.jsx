                ...
                <Table sx={{ minWidth: 650 }}>
                    <TableHead sx={{ backgroundColor: '#DAE1F3' }}>
                        <TableRow>
                            ...
                            <TableCell sx={{ fontWeight: 600 }}>Installment Amt.</TableCell>
                            <TableCell sx={{ fontWeight: 600 }}>Paymode</TableCell>
                        ...
                        {filteredBlocks.map((block) => (
                            <React.Fragment key={block.blockId}>
                                <TableRow>
                                    ...
                                    <TableCell sx={{ fontWeight: 500 }}>{block.installmentAmount}</TableCell>
                                    <TableCell sx={{ fontWeight: 500 }}>{block.payMode}</TableCell>
                                    <TableCell sx={{ fontWeight: 500 }}>{block.date}</TableCell>                                    <TableCell sx={{ fontWeight: 500 }}>{block.instAmount}</TableCell>
